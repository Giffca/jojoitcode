...
export default function About() {
  ...
  <div>
    ...
    <article className="breadText"><h2>Om oss</h2><br></br>Vi är ett företag baserat i Jönköping som består av två stycken nyutbildade webmasters; <br></br><br></br> <span className="bigger">Timmy Johansson & Anton Josefsson </span><br></br><br></br>Vi lärde känna varandra i början av våra studier och har sedan dess studerat igenom programmen: <br></br><br></br><span className="bigger">"Mjukvaruutveckling och mobila plattformar"</span><br></br><span className="smaller">Jönköping University<br></br>2014-2016</span><br></br><br></br><span className="bigger">"Webbutvecklare" & "Webmaster"</span><br></br><span className="smaller">Högskolan Väst<br></br>2017-2020</span><br></br><br></br></article>
    </div>
